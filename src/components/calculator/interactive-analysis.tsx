    ...
    <motion.div variants={itemVariants}>
      <Card>
        <CardContent className="p-5 space-y-5">
          ...
          {(l.id || dbSavedId) && (
            <Link
              href={`/report/${l.id ?? dbSavedId}`}
              className="flex items-center gap-3 rounded-xl border border-border/50 bg-card p-4 hover:bg-card-hover hover:border-accent/20 transition-all"
            >
