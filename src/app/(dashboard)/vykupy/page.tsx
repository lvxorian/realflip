...
export default function OffMarketPage() {
  ...
  return (
    ...
    >
      ...
      <AuctionAnalyzer onParsed={setParsed} />
      <AuctionCalculator data={parsed} />

      {/* ===== Portál dražeb (hunter leads) ===== */}
      <Card>
        <CardContent className="p-5">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <span className="font-semibold tracking-tight text-sm">Portál dražeb</span>
              <span className="text-xs text-muted">({leads.length})</span>
              {leadsOpen ? <CaretUp size={14} weight="bold" /> : <CaretDown size={14} weight="bold" />}
            </button>
