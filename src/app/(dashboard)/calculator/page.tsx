...
export default function CalculatorPage() {
  ...
  const result = useMemo(() => {
    ...
    const location = classifyLocation(title, title);
    ...
    const marketLowNum = parseInt(marketLow) || 0;
    const marketHighNum = parseInt(marketHigh) || 0;
    ...
    return {
      ...
      analysis: {
        ...
        marketPricePerSqmLow: marketLowNum || analysis.marketPricePerSqmLow,
        marketPricePerSqmHigh: marketHighNum || analysis.marketPricePerSqmHigh,
