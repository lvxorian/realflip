...
- **Engine robustnost**: váha nabídek dle počtu vzorků (min(sampleSize,8)/8), clamp nabídek do [0,75×; 1,25×] realizovaných, partial pooling (čtvrť nad krajem o >35 % → korekce 0,75/0,25 ke kraji — novostavby), srážka ×0,94 za běžný stav („good") u čtvrti/obce (mix novostaveb v průměru), spread 0,05–0,18, confidence cap 95 (nikdy 100 %). DB kompy (Tier 1) vylučují novostavby (condition new) a u „any" aplikují multiplikátory — konzistence se sreality tierem. Multiplikátory: floor (0. patro 0,95 / 1. patro 0,98), yearBuilt (<1945 0,96 … >2015 1,08), areaSizeFactor (exponent 0,25, clamp 0,7–1,3).
